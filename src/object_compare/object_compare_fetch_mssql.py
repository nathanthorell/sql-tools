def get_mssql_stored_proc_query(schema_name: str) -> str:
    return f"""
        SELECT
...
def get_mssql_view_query(schema_name: str) -> str:
    return f"""
        SELECT
...
def get_mssql_function_query(schema_name: str) -> str:
    return f"""
        SELECT
...
def get_mssql_table_query(schema_name: str) -> str:
    return f"""
        SELECT
...
def get_mssql_trigger_query(schema_name: str) -> str:
    return f"""
        SELECT
...
def get_mssql_sequence_query(schema_name: str) -> str:
    return f"""
        SELECT
...
def get_mssql_index_query(schema_name: str) -> str:
    return f"""
        SELECT
...
def get_mssql_type_query(schema_name: str) -> str:
    return f"""
        SELECT
...
def get_mssql_external_table_query(schema_name: str) -> str:
    return f"""
        SELECT
...
def get_mssql_foreign_key_query(schema_name: str) -> str:
    return f"""
        SELECT
